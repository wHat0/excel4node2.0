[![NPM version](https://img.shields.io/npm/v/excel4node2.0.svg)](https://www.npmjs.com/package/excel4node2.0)
[![License](https://img.shields.io/badge/License-MIT-brightgreen.svg)](https://opensource.org/licenses/MIT)
[![npm](https://img.shields.io/npm/dt/excel4node2.0.svg)](https://www.npmjs.com/package/excel4node2.0)
[![node](https://img.shields.io/node/v/excel4node2.0.svg)](https://nodejs.org/en/download/)
[![Build Status](https://travis-ci.org/wHat0/excel4node2.0.svg?branch=master)](https://travis-ci.org/wHat0/excel4node2.0)
[![dependencies Status](https://david-dm.org/wHat0/excel4node2.0/status.svg)](https://david-dm.org/wHat0/excel4node2.0)
[![devDependency Status](https://david-dm.org/wHat0/excel4node2.0/dev-status.svg)](https://david-dm.org/wHat0/excel4node2.0#info=devDependencies)

# excel4node2.0

A full featured xlsx file generation library allowing for the creation of advanced Excel files.

excel4node2.0 conforms to the ECMA-376 OOXML specification 2nd edition
...
excel4node2.0 comes with some generic functions and types
...
Conditional formatting adds custom formats in response to cell reference state. A subset of conditional formatting features is currently supported by excel4node2.0.  
...
Multiple groupings can be nested as demonstrated in [this gist](https://gist.github.com/wHat0/b548fe8d2ea00c5b9fa94597c2cf9fd2)
